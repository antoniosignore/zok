...
public class CandleGSON {
    ...
    public static void main(String[] args) {
        ...
        List<CandleGSON> ds = new ArrayList<CandleGSON>();
    ...
    private static CandleGSON buildDaily(String day, String val) {
        CandleGSON d1 = new CandleGSON();
        d1.period = day;
        d1.setClose(val);
        return d1;
    }
