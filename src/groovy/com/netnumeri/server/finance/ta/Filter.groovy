...
public class Filter {
    ...
    protected static final double TINY = 1.0e-20F;
    ...
    throws NRError {
        int isign;
        double[] respns = NumericalRecipes.vector(1, n);
        int np = nl + nr + 1;
        isign = 1;
    ...
    throws NRError {
        ...
        for (j = 3; j <= n + 1; j += 2) {
            ...
            fft2[j] = aip;
            fft2[j + 1] = -rem;
            //System.out.println("nn2 - j: " + (nn2 - j) + "Len: " + fft2.length);
            fft2[nn2 - j] = aip;
            fft2[nn3 - j] = rem;
        }
    }

    private static double[] velfilter(double[] data, int N, int derivative, int nl, int nr)
    throws NRError {
        int i, j;
        int isign;
        double cmp;
    ...
    public static void test_velfilter(double[] data)
    throws NRError {
        int i, j;
        int isign;
        double[] respns;
    ...
    throws NRError {
        ...
        for (i = 1; i <= N; i++) {
            ...
            cmp += data[i] * respns[1];
            System.out.println("" + i + "\t" + ans[i] + "\t" + cmp);
        }
    }
    ...
    public static Map computeArmonics(double[] data) throws NRError {
        Map ret = new HashMap();
...
//            int N = 512;
//
//            double[] data = NumericalRecipes.vector(1, N);
//            for (int i = 1; i <= N; i++) {
...
//
//            double[] filter = (double[]) ret.get("filter");
//            for (int i = 1; i <= N; i++) {
//                System.out.println(filter[i]);
//            }
//
//            double[] doublefilter = (double[]) ret.get("doublefilter");
//            for (int i = 1; i <= N; i++) {
//                System.out.println(filter[i]);
//            }
//
//            double[] d1 = (double[]) ret.get("d1");
//            for (int i = 1; i <= N; i++) {
//                System.out.println(d1[i]);
//            }
//
//            double[] d2 = (double[]) ret.get("d2");
//            for (int i = 1; i <= N; i++) {
