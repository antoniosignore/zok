...
<div data-ng-controller="StockCtrl" >
    <h1>Stock List</h1>
 	<div data-ng-show="errors.showErrors" class="red">
        ...
        <div>
            <p></p>
             <a class="btn btn-primary btn-primary" data-ng-click="newStock()"><span class="glyphicon glyphicon-plus"></span><g:message code="default.new.label" args="['stock']" default="New stock"/></a>
            <p></p>
        </div>
        <div>
            <div>
