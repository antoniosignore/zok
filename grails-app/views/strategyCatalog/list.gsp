...
<div data-ng-controller="StrategyCatalogCtrl" >
    <h1>StrategyCatalog List</h1>
 	<div data-ng-show="errors.showErrors" class="red">
        ...
        <div>
            <p></p>
             <a class="btn btn-primary btn-primary" data-ng-click="newStrategyCatalog()"><span class="glyphicon glyphicon-plus"></span><g:message code="default.new.label" args="['strategyCatalog']" default="New strategyCatalog"/></a>
            <p></p>
        </div>
        <div>
            <div>
